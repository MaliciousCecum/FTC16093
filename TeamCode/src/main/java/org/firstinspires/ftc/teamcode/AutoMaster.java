...
public abstract class AutoMaster extends LinearOpMode {
   ...
   Pose2d MIDDLE_POS, GRAB_POS, SIDE_POS, startPos;
...
//         }
//      });
      MIDDLE_POS = new Pose2d(1200, side_eject_y * startSide, Math.toRadians(-117) * startSide);
...
//      if (!upper.checkConeValid()) throw new ConeException();
   ...
   protected void eject(Junction pos, int stable_time) throws Exception {
      ...
      drive.initSimpleMove(pos == Junction.MIDDLE ? MIDDLE_POS : SIDE_POS);
      drive.waitForIdle();
