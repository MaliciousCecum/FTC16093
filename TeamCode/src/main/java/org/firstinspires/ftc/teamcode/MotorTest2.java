...
public class MotorTest2 extends LinearOpMode {
   ...
   public static String motor0_name = "rightLift";
   public static String motor1_name = "leftLift";
   ...
   public void runOpMode() {
      ...
      while (opModeIsActive()) {
         ...
         telemetry_M.addData("encoder0", motor0.getCurrentPosition());
         telemetry_M.addData("encoder1", motor1.getCurrentPosition());
